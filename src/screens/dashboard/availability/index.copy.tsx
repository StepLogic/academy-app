...
// import { excludeDate, validateSlots, updateValue } from './functions';
import {
  Animated,
  Dimensions,
  ScrollView,
          ...
          >
            ...
            <View style={[{ flexDirection: "column", flex: 1 }]}>
              ...
              <View style={[styles.grid]}>
                {slotsState.map((period: any, idx: number) => (
                  <View style={[styles.periodRow]} key={"key" + idx * 9}>
                    {period.map((slot: any) => (
                      <Slot
                        id={slot.id}
                        key={slot.id + "k"}
                        ...
                        exclude={excludeDate(slot.value)}
                        disabled={excludeDate(slot.value) || progress !== 0}
